...
class Voice(BaseSoftDeleteModel):
    ...
    user = models.ForeignKey("CustomUser", on_delete=models.CASCADE, related_name="voices", blank=True)
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=["photo", "user"], name="unique_voice")]
