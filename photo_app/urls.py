...
from photo_app.views.photo.views import ListPhotoAPIView, UploadPhotoView, DeletePhotoView, DetailPhotoAPIView, EditPhotoView, RestorePhotoView
...
urlpatterns = [
    path('api/v1/photo_list', ListPhotoAPIView.as_view(), name='home'),
    path('vote/', VoiceView.as_view(), name='vote'),
    path('upload/', UploadPhotoView.as_view(), name='upload'),
    path('photo/<int:photo>/', DetailPhotoAPIView.as_view(), name='detail'),
